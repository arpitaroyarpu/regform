            ...
            if ($password === $confirm_password) {
                ...
                if ($result) {
                    ...
                    try {
                        ...
                        $mail->Body    = 'Here is the verification link <b><a href="http://localhost/regform/index.php?verification='.$code.'">http://localhost/regform/index.php?verification='.$code.'</a></b>';
